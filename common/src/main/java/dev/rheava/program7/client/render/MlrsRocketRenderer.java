 ...
 * real finned-rocket texture is a later art pass.
 */
public class MlrsRocketRenderer extends EntityRenderer<MlrsRocketEntity> {
	...
	private final MlrsRocketModel model;

	public MlrsRocketRenderer(EntityRendererFactory.Context context) {
		super(context);
		this.model = new MlrsRocketModel(context.getPart(MlrsRocketModel.LAYER));
		this.shadowRadius = 0.3f;
	}

	@Override
	public void render(MlrsRocketEntity entity, float yaw, float tickDelta, MatrixStack matrices,
	...
	@Override
	public Identifier getTexture(MlrsRocketEntity entity) {
		return TEXTURE;
	}
}
