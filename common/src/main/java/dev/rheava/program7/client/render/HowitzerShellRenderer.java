 ...
 * real heavy-shell texture is a later art pass.
 */
public class HowitzerShellRenderer extends EntityRenderer<HowitzerShellEntity> {
	private static final Identifier TEXTURE = Program7.id("textures/entity/mortar_shell.png");

	private final HowitzerShellModel model;

	public HowitzerShellRenderer(EntityRendererFactory.Context context) {
		super(context);
		this.model = new HowitzerShellModel(context.getPart(HowitzerShellModel.LAYER));
		this.shadowRadius = 0.35f;
	}

	@Override
	public void render(HowitzerShellEntity entity, float yaw, float tickDelta, MatrixStack matrices,
	...
	@Override
	public Identifier getTexture(HowitzerShellEntity entity) {
		return TEXTURE;
	}
}
